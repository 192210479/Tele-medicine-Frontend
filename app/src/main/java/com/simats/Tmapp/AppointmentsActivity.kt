...
class AppointmentsActivity : AppCompatActivity() {
    ...
    private fun filterAndDisplay() {
        ...
        // Sorting: Nearest date and localTime for Upcoming, Newest first for others
        val sorted = if (currentTab == 0) {
            ...
            filtered.sortedWith(compareByDescending<AppointmentResponse> { it.date ?: "" }.thenByDescending { it.localTime ?: "" })
        }
