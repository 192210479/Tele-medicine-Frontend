...
class DoctorVideoCallActivity : AppCompatActivity() {
    ...
    private val timerRunnable = object : Runnable {
        override fun run() {
            if (startedAt > 0) {
                // Normalize startedAt to seconds if it's in milliseconds
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<FloatingActionButton>(R.id.fabMic).setOnClickListener {
            ...
            fab.backgroundTintList = android.content.res.ColorStateList.valueOf(
                if (isMicOn) android.graphics.Color.parseColor("#B3000000") else android.graphics.Color.parseColor("#EF4444")
            )
        ...
        findViewById<FloatingActionButton>(R.id.fabVideo).setOnClickListener {
            isVideoOn = !isVideoOn
            val fab = it as FloatingActionButton
            fab.setImageResource(if (isVideoOn) R.drawable.ic_video else R.drawable.ic_video_off)
            fab.backgroundTintList = android.content.res.ColorStateList.valueOf(
                if (isVideoOn) android.graphics.Color.parseColor("#B3000000") else android.graphics.Color.parseColor("#EF4444")
            )
            videoCallManager.setVideoEnabled(isVideoOn)
            
            // UI Reflection: OFF -\u003e stop video feed and show placeholder
        ...
        findViewById<FloatingActionButton>(R.id.fabSpeaker).setOnClickListener {
            ...
            fab.backgroundTintList = android.content.res.ColorStateList.valueOf(
                if (isSpeakerOn) android.graphics.Color.parseColor("#2F6FED") else android.graphics.Color.parseColor("#B3000000")
            )
