...
class ProfileViewModel : ViewModel() {
    ...
    private val _documentUpdateStatus = MutableLiveData<Pair<Boolean, String?>>()
    val documentUpdateStatus: LiveData<Pair<Boolean, String?>> get() = _documentUpdateStatus

    fun updateDoctorDocuments(userId: RequestBody, license: MultipartBody.Part?, medical: MultipartBody.Part?) {
        repository.updateDoctorDocuments(userId, license, medical) { success, error ->
            _documentUpdateStatus.postValue(Pair(success, error))
        }
    }
