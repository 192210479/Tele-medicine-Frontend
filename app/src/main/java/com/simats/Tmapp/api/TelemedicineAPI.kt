...
interface TelemedicineAPI {
    ...
    fun registerDoctorMultipart(
        ...
        @Part("experience_years") experienceYears: RequestBody? = null,
        @Part("fee") fee: RequestBody? = null,
        @Part("languages") languages: RequestBody? = null,
        @Part("bio") bio: RequestBody? = null,
        @Part license_file: MultipartBody.Part,
        @Part medical_record_file: MultipartBody.Part? = null
    ...
    fun updateDoctorDocuments(
        ...
        @Part license_file: MultipartBody.Part? = null,
        @Part medical_record_file: MultipartBody.Part? = null
    ...
    fun getAllAppointmentsV2(@Query("role") role: String): Call<List<AppointmentResponse>>
    ...
    fun setConsultationReadyV2(@Body request: ConsultationReadyRequest): Call<GenericResponse>
    ...
    fun createPaymentOrder(@Body request: RazorpayOrderRequest): Call<RazorpayOrderResponse>
    ...
    fun getPatientInvoices(@Query("patient_id") userId: Int): Call<List<InvoiceResponse>>

    @GET("api/doctor/wallet/summary")
    fun getDoctorWallet(@Query("doctor_id") userId: Int): Call<DoctorWalletResponse>

    @GET("api/doctor/transactions")
    fun getDoctorTransactionsV2(@Query("doctor_id") userId: Int): Call<List<TransactionResponse>>

    @GET("api/admin/finance/summary")
    fun getAdminFinanceSummary(): Call<AdminFinanceSummaryResponse>
