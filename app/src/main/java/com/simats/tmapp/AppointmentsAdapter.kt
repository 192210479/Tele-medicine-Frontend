...
class AppointmentsAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (isDoctor) {
            ...
            val avatarUrl = "$baseUrl/api/profile/image/${appointment.patientId}?role=patient"
            ...
            val avatarUrl = "$baseUrl/api/profile/image/${appointment.doctorId}?role=doctor"
            Glide.with(holder.itemView.context)
                .load(avatarUrl)
                .placeholder(R.drawable.bg_circle_soft_blue)
                .error(R.drawable.bg_circle_soft_blue)
        ...
        // Parse date and time
        val combinedUtc = "${appointment.date} ${appointment.time}"
